...
*    Credit信用卡付款產生訂單範例
*/
$orderId = $_POST['orderIdToGreen'];
$totalPrice = $_POST['priceToGreen'];
    ...
    try {
        ...
        $obj->Send['ClientBackURL']         = "https://tibamef2e.com/tgd101/g2/dist/orderCompleted.html" ;    //付款完成前往orderCompleted.html
        ...
        //訂單的商品資料
        array_push($obj->Send['Items'], array('Name' => $orderId, 'Price' => (int)$totalPrice,
